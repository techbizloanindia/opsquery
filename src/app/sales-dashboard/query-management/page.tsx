...
import SalesQueryManagement from '@/components/sales/SalesQueryManagement';
...
export default function SalesQueryManagementPage() {
  ...
  useEffect(() => {
    ...
    import('@/lib/queryUpdateService').then(({ queryUpdateService }) => {
      ...
      console.log('< Sales Query Management Page: Initialized query update service');
    });
    ...
    import('@/lib/querySyncService').then(({ querySyncService }) => {
      ...
      console.log('= Sales Query Management Page: Started auto-sync for sales team');
